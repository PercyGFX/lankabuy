...
<html lang="en-US" itemscope="itemscope" itemtype="http://schema.org/WebPage">
    <head>
        ...
        <title>Lankabuy Electronics</title>
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/bootstrap.min.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/font-awesome.min.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/bootstrap-grid.min.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/bootstrap-reboot.min.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/font-techmarket.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/slick.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/techmarket-font-awesome.css')}}" media="all" />
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/slick-style.css')}}" media="all" />
        ...
        <link rel="stylesheet" type="text/css" href="{{asset('frontend/css/colors/blue.css')}}" media="all" />
    ...
    <body class="woocommerce-active page-template-template-homepage-v1 can-uppercase">
        <div id="page" class="hfeed site">
                ...
                <div class="col-full desktop-only">
                            ...
                            <nav id="primary-navigation" class="primary-navigation" aria-label="Primary Navigation" data-nav="flex-menu">
                                <ul id="menu-primary-menu" class="nav yamm">
                                    <li class="sale-clr yamm-fw menu-item animate-dropdown">
                                        ...
                                        <a title="Super deals" href="/user-logout">Logout</a>

                                            <?php } else{ ?>

                                                <a title="Super deals" href="/login-check">Login</a>
                                   ...
                                   <!-- <li class="menu-item menu-item-has-children animate-dropdown dropdown">
                                    ...
                                    <li class="menu-item animate-dropdown">
                                            <?php $customer_id=Session::get('cus_id'); ?>
                                            <?php if($customer_id != NULL) { ?>
                                        <a title="Logitech Sale" href="/my-account">My Account</a>
                                        <?php } else{ ?>
                                            <a title="Logitech Sale" href="/login-check">My Account</a>
                                            <?php } ?>
                                    </li>
                                    <li class="menu-item animate-dropdown">
                                            <?php $customer_id=Session::get('cus_id'); ?>
                                            <?php if($customer_id != NULL) { ?>
                                        <a title="Headphones Sale" href="/checkout">Checkout</a>
                                        <?php } else{ ?>
                                            <a title="Headphones Sale" href="/login-check">Checkout</a>
                                            <?php } ?>
                                    </li>
                    ...
                    <div class="row align-items-center">
                        <div id="departments-menu" class="dropdown departments-menu">
                           ...
                           foreach($published_category->slice(0, 10) as $active_category)  { ?>
                        
                        
                                <li class="menu-item menu-item-type-custom animate-dropdown">
                                    <a title="Gadgets" href="{{URL::to('/category/'.$active_category->category_id)}}">{{$active_category->category_name}}</a>
                                </li>
                        ...
                        <!-- .departments-menu -->
                        <form class="navbar-search" method="post" action="/search-products">
                            @csrf
                    ...
                    -->
                        ...
                        <ul id="site-header-cart" class="site-header-cart menu">
                            <li class="animate-dropdown dropdown ">
                                <a class="cart-contents" href="/show-cart" title="View your shopping cart">
                                    <i class="tm tm-shopping-bag"></i>
                                   <!-- <span class="count">2</span> -->
                                    <span class="amount">
                                        <span class="price-label">View Cart</span></span>
                                </a>
                    ...
                    <div class="handheld-header">
                        ...
                        <div class="techmarket-sticky-wrap">
                            <div class="row">
                                ...
                                <!-- .site-search -->
                                <a class="handheld-header-cart-link has-icon" href="/show-cart" title="View your shopping cart">
                                    <i class="tm tm-shopping-bag"></i>
                                   <!-- <span class="count">2</span> -->
                                </a>
                            </div>
                    ...
                    <div class="row">
                        <div id="primary" class="content-area">
							...
							<div class="home-v1-slider home-slider">
                                    <div class="slider-1" style="background-image: url({{URL::to('frontend/images/slider/home-v1-background.jpg')}});">
                                        ...
                                        <div class="caption">
                                            ...
                                            <div class="bottom-caption">Free shipping islandwide</div>
                                        </div>
                                    </div>
                                    <!-- .slider-1 END -->
                                    <div class="slider-1 slider-2" style="background-image: url({{URL::to('frontend/images/slider/home-v1-background.jpg')}});">
            ...
            <footer class="site-footer footer-v1">
                <div class="col-full">
                                    ...
                                    <div class="footer-contact-info">
                                        <div class="media">
                                            ...
                                            <div class="media-body">
                                                ...
                                                <span class="call-us-text">(+94)77 5001170</span>
                                                <address class="footer-contact-address">17 Princess Road, Rajagiriya, Colombo, Sri Lanka</address>
                                            ...
                                            <div class="media-body">
                                                ...
                                                <div class="footer-payment-icons">
                                                    ...
                                                    <ul class="list-payment-icons nav">
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{URL::to('frontend/images/credit-cards/mastercard.svg')}}" alt="mastercard" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{URL::to('frontend/images/credit-cards/visa.svg')}}" alt="visa" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{URL::to('frontend/images/credit-cards/paypal.svg')}}" alt="paypal" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="payment-icon-image" src="{{URL::to('frontend/images/credit-cards/maestro.svg')}}" alt="maestro" />
                                                        </li>
                                                    </ul>
                                                -->
                                                </div>
                                                ...
                                                <div class="footer-secure-by-info">
                                                    ...
                                                    <ul class="footer-secured-by-icons">
                                                        <li class="nav-item">
                                                            <img class="secure-icons-image" src="{{URL::to('frontend/images/secured-by/norton.svg')}}" alt="norton" />
                                                        </li>
                                                        <li class="nav-item">
                                                            <img class="secure-icons-image" src="{{URL::to('frontend/images/secured-by/mcafee.svg')}}" alt="mcafee" />
                                                        </li>
                                                    </ul>
                                                </div>
                                            -->
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="menu-footer-menu-1-container">
                                                <ul id="menu-footer-menu-1" class="menu">
                                                            ...
                                                            <?php foreach($published_category->slice(0, 10) as $active_category)  { ?>
                                        ...
                                        <div class="body">
                                            ...
                                            <div class="menu-footer-menu-3-container">
                                                <ul id="menu-footer-menu-3" class="menu">
                                                    <li class="menu-item">
                                                        <a href="login-and-register.html">About Us</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="track-your-order.html">Privacy Policy</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="shop.html">Cart</a>
                                                    </li>
                                                    <li class="menu-item">
                                                        <a href="wishlist.html">Payment</a>
                                                    </li>
                    ...
                    <div class="site-info">
                        <div class="col-full">
                            <div class="copyright">Copyright &copy; 2019 <a href="/">Lankabuy</a> International. All rights reserved.</div>
                            <!-- .copyright -->
        ...
        <script type="text/javascript" src="{{asset('frontend/js/hidemaxlistitem.min.js')}}"></script>
        ...
        <script type="text/javascript" src="{{asset('frontend/js/scrollup.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('frontend/js/jquery.waypoints.min.js')}}"></script>
        <script type="text/javascript" src="{{asset('frontend/js/waypoints-sticky.min.js')}}"></script>
